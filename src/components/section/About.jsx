...
const About = () => {
    //Skills
    const skills = [
        { name: 'React.js', icon: SiReact, color: '#2563EB' },
        { name: 'Tailwind.js', icon: SiTailwindcss, color: '#2563EB' },
        { name: 'Java', icon: FaJava, color: '#2563EB' },
        { name: 'Html', icon: FaHtml5, color: '#2563EB' },
        { name: 'Css', icon: FaCss3Alt, color: '#2563EB' },
        { name: 'MySql', icon: FaDatabase, color: '#2563EB' },
    ];
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-20">
                ...
                <div className="flex flex-col gap-12">
                    <div className="flex flex-col gap-8">
                        ...
                        <FadeIn delay={100}>
                            <h2 className="text-4xl lg:text-5xl font-normal text-white loading-tight">
                        ...
                        <div className="grid grid-cols-3 gap-8">
                            {ABOUT_STATS.map((stat, index) => (
                                <div key={index} className="relative">
                                    ...
                                    <div className="text-3xl font-normal text- mb-2 font-mono">
                                        {stat.Value}
                                    </div>
                    ...
                    <FadeIn delay={400}>
                        <button 
                         ...
                         className="inline-flex items-center gap-3 bg-white hover:bg-white/50 text-primary rounded-full px-8 py-4 text-base font-medium transition-all duration-300 w-fit group"
                         >
                    ...
                    <div className="grid grid-cols-2 gap-4">
                                ...
                                <div className="flex items-start gap-4">
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <p className="text-sm text-white/70 leading-relaxed">
                                            Specialized in building Web application with modern technology
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="relative group">
                            ...
                            <div className="relative bg-white/5 border border-white/10 rounded-2xl p-6 hover:border-primary/30 transition-all duration-300 h-full">
                                ...
                                <p className="text-sm text-white/70 leading-relaxed">
                                    Writting Maintainable, well-documented code that scale.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="col-span-2 relative group">
                            <div className="absolute inset-0 bg-linear-to-br from-primary/10 to-primary/5 rounded-2xl blur-xl opacity-50 group-hover:opacity-75 transition-opacity duration-300"></div>
                            <div className="relative bg-white/5 border border-white/10 rounded-2xl p-6 hover:border-primary/30 transition-all duration-300 h-full">
                                <div className="grid grid-cols-3 gap-6 test-center">
                                    <div>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 w-full max-w-4xl">
                        {skills.map((skill, index) => (
                            ...
                            >
                                ...
                                <div className="text-sm text-white/80 font-medium text-center text-center">
                                    {skill.name}
                                </div>

                                {/* Hover Glow Effect */}
                                <div className="absolute inset-0 bg-linear-to-br from-primary/0 to-primary/8 group-hover:from-primary/10 group-hover:to-primary/10 rounded-2xl transition-all duration-300"></div>
                            </div>
                        ))}
                    </div>
                </div>
