            ...
            <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <FadeIn delay={0}>
                    <div className="text-center mb-12">
                        ...
                        <p className="text:lg text-white/60 mas-w-2xl mx-auto">
                ...
                <FadeIn delay={200}>
                    <div className="relative">
                        <div 
                            ref={scrollContainerRef}className="overflow-x-auto scroll-smooth snap-x snap-mandatory hide-scrollbar"
                        >
                        ...
                        {filteredProjects.length > 3 && (
                            <>
                                <button
                                    ...
                                    className="flex absolute left-0 top-1/2 -translate-y-1/2 -translate-x-2 lg:translate-x-4 items-center justify-center w-10 h-10 lg:w-12 lg_h-12 bg-white/10 backdrop-blur-sm border border-white/20 rounded-full hover-bg-white/20 trasnition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed z-10"
                                ...
                                <button
                                    ...
                                    className="flex absolute right-0 top-1/2 -translate-y-1/2 translate-x-2 translate-x-4 items-center justify-center w-10 h-10 lg:w-12 lg:h-12 bg-white/10 backdrop-blur-sm border border-white/20 rounded-full hover-bg-white/20 trasnition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed z-10"
