...
const RadialGradientBackground = ({varient='hero', gradients=[]}) => {
        ...
        hero: [
            {
               ...
               colors: [
                {color: 'rgba(59, 130, 246, 0.25)', stop: '100%' },
                {color: 'rgba(59, 130, 246, 0.45)', stop: '100%' },
                {color: 'rgba(59, 130, 246, 0.5)', stop: '100%' },
                {color: 'rgba(59, 130, 246, 0.25)', stop: '100%' },
                {color: 'rgba(59, 130, 246, 0.45)', stop: '100%' },
               ],
               blur: '0px',
    ...
    const activeGradients = varient === 'custom' ? gradients : varients[varient] || varients.hero;
